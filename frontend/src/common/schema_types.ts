...
//   const officialCardImage = Convert.toOfficialCardImage(json);
...
export interface ImportSiteDecklistResponse {
    cards:           string;
    officialImages?: OfficialCardImage[];
}

export interface OfficialCardImage {
    collectorNumber?: string;
    expansionCode?:   string;
    face:             Face;
    name:             string;
...
export class Convert {
    ...
    public static toOfficialCardImage(json: string): OfficialCardImage {
        return cast(JSON.parse(json), r("OfficialCardImage"));
    }

    public static officialCardImageToJson(value: OfficialCardImage): string {
        return JSON.stringify(uncast(value, r("OfficialCardImage")), null, 2);
    }
...
const typeMap: any = {
    ...
    "ImportSiteDecklistResponse": o([
        ...
        { json: "officialImages", js: "officialImages", typ: u(undefined, a(r("OfficialCardImage"))) },
    ], false),
    "OfficialCardImage": o([
        { json: "collectorNumber", js: "collectorNumber", typ: u(undefined, "") },
        { json: "expansionCode", js: "expansionCode", typ: u(undefined, "") },
        { json: "face", js: "face", typ: r("Face") },
        { json: "name", js: "name", typ: "" },
        { json: "pngUrl", js: "pngUrl", typ: "" },
        { json: "quantity", js: "quantity", typ: 0 },
        { json: "scryfallId", js: "scryfallId", typ: "" },
    ], false),
