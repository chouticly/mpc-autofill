...
class SourceSettings(BaseModel):
    ...
    def to_dict(self) -> dict:
        result: dict = {}
        result["sources"] = from_list(lambda x: from_list(lambda x: from_union([from_int, from_bool], x), x), self.sources)
        return result
...
class CanonicalCardClass(BaseModel):
    ...
    def from_dict(obj: Any) -> 'CanonicalCardClass':
        ...
        return CanonicalCardClass(collectorNumber, expansionCode, expansionName, identifier, mediumThumbnailUrl, smallThumbnailUrl, artist, canonicalId)
...
class Card(BaseModel):
    ...
    def from_dict(obj: Any) -> 'Card':
        ...
        return Card(cardType, dateCreated, dateModified, dpi, extension, identifier, language, mediumThumbnailUrl, name, priority, searchq, size, smallThumbnailUrl, source, sourceId, sourceName, sourceVerbose, tags, canonicalArtist, canonicalCard, sourceExternalLink, sourceType)
    ...
    def to_dict(self) -> dict:
        ...
        if self.canonicalArtist is not None:
            result["canonicalArtist"] = from_union([from_none, lambda x: to_class(CanonicalArtistClass, x)], self.canonicalArtist)
        if self.canonicalCard is not None:
            result["canonicalCard"] = from_union([from_none, lambda x: to_class(CanonicalCardClass, x)], self.canonicalCard)
...
class SourceContribution(BaseModel):
    ...
    def from_dict(obj: Any) -> 'SourceContribution':
        ...
        return SourceContribution(avgdpi, description, name, qtyCardbacks, qtyCards, qtyTokens, size, sourceType, externalLink)
...
class ErrorResponse(BaseModel):
    ...
    def to_dict(self) -> dict:
        ...
        if self.errors is not None:
            result["errors"] = from_union([lambda x: from_list(lambda x: from_dict(lambda x: x, x), x), from_none], self.errors)
...
class OfficialCardImage(BaseModel):
    face: Face
    name: str
    pngUrl: str
    quantity: int
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'OfficialCardImage':
        assert isinstance(obj, dict)
        face = Face(obj.get("face"))
        name = from_str(obj.get("name"))
        pngUrl = from_str(obj.get("pngUrl"))
        quantity = from_int(obj.get("quantity"))
        scryfallId = from_str(obj.get("scryfallId"))
        collectorNumber = from_union([from_str, from_none], obj.get("collectorNumber"))
        expansionCode = from_union([from_str, from_none], obj.get("expansionCode"))
        return OfficialCardImage(face, name, pngUrl, quantity, scryfallId, collectorNumber, expansionCode)

    def to_dict(self) -> dict:
        result: dict = {}
        result["face"] = to_enum(Face, self.face)
        result["name"] = from_str(self.name)
        result["pngUrl"] = from_str(self.pngUrl)
        result["quantity"] = from_int(self.quantity)
        result["scryfallId"] = from_str(self.scryfallId)
        if self.collectorNumber is not None:
            result["collectorNumber"] = from_union([from_str, from_none], self.collectorNumber)
        if self.expansionCode is not None:
            result["expansionCode"] = from_union([from_str, from_none], self.expansionCode)
...
class ImportSiteDecklistResponse(BaseModel):
    cards: str
    officialImages: Optional[List[OfficialCardImage]] = None

    @staticmethod
    def from_dict(obj: Any) -> 'ImportSiteDecklistResponse':
        assert isinstance(obj, dict)
        cards = from_str(obj.get("cards"))
        officialImages = from_union([lambda x: from_list(OfficialCardImage.from_dict, x), from_none], obj.get("officialImages"))
        return ImportSiteDecklistResponse(cards, officialImages)

    def to_dict(self) -> dict:
        result: dict = {}
        result["cards"] = from_str(self.cards)
        if self.officialImages is not None:
            result["officialImages"] = from_union([lambda x: from_list(lambda x: to_class(OfficialCardImage, x), x), from_none], self.officialImages)
        return result
...
class Patreon(BaseModel):
    ...
    def to_dict(self) -> dict:
        ...
        result["tiers"] = from_union([from_none, lambda x: from_dict(lambda x: to_class(SupporterTier, x), x)], self.tiers)
...
def OfficialCardImagefromdict(s: Any) -> OfficialCardImage:
    return OfficialCardImage.from_dict(s)


def OfficialCardImagetodict(x: OfficialCardImage) -> Any:
    return to_class(OfficialCardImage, x)
